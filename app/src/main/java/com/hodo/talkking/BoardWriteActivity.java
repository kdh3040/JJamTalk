    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CommonFunc.getInstance().ShowDefaultPopup(BoardWriteActivity.this, listener, "게시판 글쓰기","작성한 글을 게시하시겠습니까?(작성된 글은 수정할 수 없고 삭제만 할 수 있습니다. 게시판글은 10분에 한번씩만 작성할 수 있습니다.)", "네", "취소" );
